<?php
//Membuat Koneksi PHP
$conn = mysqli_connect('localhost', 'root', '', 'pskd02') or die("<h3>MySQL connection is failed.</h3><br>"); 
...
function daftar($data){
    ...
    $cekusername = mysqli_query($conn, "SELECT username FROM registrasi_user WHERE username = '$username'");
    ...
    $cekemail = mysqli_query($conn, "SELECT email FROM registrasi_user WHERE email = '$email'");
        ...
        elseif(!$specialChars){
            ...
            mysqli_query ($conn, "INSERT INTO registrasi_user VALUES ('$username','$passwordmd5','$email','$address','$nama','$role','$aktif','$token')");
            include 'mail.php';
