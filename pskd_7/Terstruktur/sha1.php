...
if (isset($_POST['ubah'])) {
    ...
    //Untuk Memasukkan Data yang sudah diinputkan ke dalam database
    mysqli_query($koneksi, "INSERT INTO ujicoba VALUES ('$string1','$string2')");
}
?>
<!doctype html>
<html lang="en">
            ...
            <form method="post">
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><input type="submit" value="UBAH" name="ubah" style="background-color: #808080;"></td>
                        <td><input type="reset" value="RESET" name="reset" style="background-color: #808080;"></td>
                    </tr>
                </table>
            </form>
            <br>
